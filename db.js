...
const connectToAtlasDb = async () => {
    try {
      atlasClient = new MongoClient(atlasUrl);  // Без лишних параметров
      await atlasClient.connect();
      console.log('Connected successfully to MongoDB Atlas красавчик!');
...
const connectToLocalDb = async () => {
  try {
    localClient = new MongoClient(localUrl);  // Без лишних параметров
    await localClient.connect();
    console.log('Connected successfully to MongoDB Local красавчик!');
